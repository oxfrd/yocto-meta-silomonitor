...
{
    return {"28ff123456789abc", "28ffabcdef123456", "28ffaabbccddeeff", "28ff001122334455"};
}

std::map<std::string, float> MockSensorProvider::getTemps()
{
    ...
    std::map<std::string, float> temps = {{"28ff123456789abc", std::round((22.5f + noise01(gen)) * 10.0f) / 10.0f},
